# microcredit tailored hierarchical pdf for profit with DPLN tails
# Rachael Meager
# April 2016 
...
# now STAN MODEL! 
# notice the continuous data is in logs here 
...
fit_data <- list(M = 3,
                 ...
                 y_neg = log(-data_split[[1]]$profit),
                 treatment_pos = data_split[[2]]$treatment,
                 y_pos = log(data_split[[2]]$profit),
...
stan_fit <- stan("stan-code/tailored-hierarchical-pdf-halfnormallaplace.stan", 
