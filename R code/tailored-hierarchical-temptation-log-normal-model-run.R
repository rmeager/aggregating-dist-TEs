# microcredit tailored hierarchical pdf for temptation with lognormal tails
# Rachael Meager
# Sept 2019
...
save.image("output/microcredit_temptation_lognormal_tailored_hierarchical_pdf_output_5000_iters.RData")

sink("output/microcredit_temptation_lognormal_tailored_hierarchical_output_table_5000_iters.txt")
print(stan_fit)
dev.off()
