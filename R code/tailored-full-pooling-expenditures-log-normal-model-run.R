# microcredit tailored full-pooling pdf for expenditures with lognormal tails
# Rachael Meager
# April 2016 
...
stan_fit <- stan("stan-code/tailored-full-pooling-pdf-log-normal-1-tail.stan", 
...
save.image("output/microcredit_expenditures_lognormal_tailored_full_pooling_pdf_output_5000_iters.RData")

#sink("output/microcredit_expenditures_lognormal_tailored_full_pooling_output_table_5000_iters.txt")
#print(stan_fit)
#dev.off()
