# microcredit tailored full-pooling pdf for revenues with lognormal tails
# Rachael Meager
# April 2016 
...
#sink("logs/tailored-full-pooling-revenues-lognormal-model-4000-iters.txt")
...
stan_fit <- stan("stan-code/tailored-full-pooling-pdf-log-normal-1-tail.stan", iter = 4000, chains = 6, data = fit_data,
...
#saveRDS(stan_fit_summary, file = "tailored_full_pooling_pdf_microcredit_output_1.RDS", ascii = FALSE, version = NULL,  compress = TRUE, refhook = NULL)

save.image("output/microcredit_revenues_lognormal_tailored_full_pooling_pdf_output_4000_iters.RData")

#sink("output/microcredit_revenues_lognormal_tailored_full_pooling_output_table_4000_iters.txt")
#print(stan_fit)
#dev.off()
