# microcredit tailored full-pooling pdf for profit with lognormal tails
# Rachael Meager
# April 2016 
...
stan_fit <- stan("stan-code/tailored-full-pooling-pdf-log-normal.stan", 
...
saveRDS(stan_fit_summary, file = "tailored_full_pooling_pdf_microcredit_output_4000_iters.RDS", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

save.image("output/microcredit_profit_lognormal_tailored_full_pooling_pdf_output_4000_iters.RData")

sink("output/microcredit_profit_lognormal_tailored_full_pooling_output_table_4000.txt")
print(stan_fit)
dev.off()
