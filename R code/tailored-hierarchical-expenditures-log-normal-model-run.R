# microcredit tailored hierarchical pdf for expenditures with lognormal tails
# Rachael Meager
# April 2016 
...
save.image("output/microcredit_expenditures_lognormal_tailored_hierarchical_pdf_output_5000_iters.RData")

sink("output/microcredit_expenditures_lognormal_tailored_hierarchical_output_table_5000_iters.txt")
print(stan_fit)
dev.off()
