...
saveRDS(stan_fit_summary, file = "tailored_hierarchical_pdf_microcredit_output_4000_iters_no_bosnia.RDS", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

save.image("output/microcredit_profit_lognormal_tailored_hierarchical_pdf_output_4000_iters_no_bosnia.RData")

sink("output/microcredit_profit_lognormal_tailored_hierarchical_output_table_4000_no_bosnia.txt")
print(stan_fit)
dev.off()
