# microcredit tailored no-pooling pdf for profit with lognormal tails
# Rachael Meager
# April 2016 
...
stan_fit <- stan("stan-code/tailored-no-pooling-pdf-log-normal.stan", 
...
#saveRDS(stan_fit_summary, file = "tailored_no_pooling_pdf_microcredit_output_5000_iters.RDS", ascii = FALSE, version = NULL, compress = TRUE, refhook = NULL)

save.image("output/microcredit_profit_lognormal_tailored_no_pooling_pdf_output_5000_iters.RData")

sink("output/microcredit_profit_lognormal_tailored_no_pooling_output_table_5000.txt")
print(stan_fit)
dev.off()
