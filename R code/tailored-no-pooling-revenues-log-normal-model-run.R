# microcredit tailored no-pooling pdf for revenues with lognormal tails
# Rachael Meager
# April 2016 
...
saveRDS(stan_fit_summary, file = "tailored_no_pooling_pdf_microcredit_output_1.RDS", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

save.image("output/microcredit_revenues_lognormal_tailored_no_pooling_pdf_output_5000_iters.RData")

sink("output/microcredit_revenues_lognormal_tailored_no_pooling_output_table_5000_iters.txt")
print(stan_fit)
dev.off()
