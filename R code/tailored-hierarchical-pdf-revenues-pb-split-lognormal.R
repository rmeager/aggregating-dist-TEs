# full tailored hierarchical pdf model for revenues 
# Rachael Meager
# April 2016 
...
data <- data.frame(site, revenues, treatment, priorbiz)
...
saveRDS(stan_fit_summary_0, file = "output/tailored_hierarchical_pdf_revenues_microcredit_output_pb_split_0_lognormal.RDS", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

stan_fit_summary_1 <- summary(stan_fit_pb_1)
stan_fit_table_1 <- xtable(stan_fit_summary_1$summary)

saveRDS(stan_fit_summary_1, file = "output/tailored_hierarchical_pdf_revenues_microcredit_output_pb_split_1_lognormal.RDS", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)


save.image("output/microcredit_revenues_tailored_hierarchical_pdf_output_pb_split_lognormal.RData")
