...
stan_fit_table_consumerdurables_full_pooling <- stan_fit_table
stan_fit_consumerdurables_full_pooling <- stan_fit
codafit_stan_draws_consumerdurables_full_pooling <- as.matrix(stan2coda(stan_fit_consumerdurables_full_pooling))

load("output/microcredit_consumption_lognormal_tailored_no_pooling_pdf_output_4000_iters.RData")
stan_fit_table_consumption_full_pooling <- stan_fit_table
stan_fit_consumption_full_pooling <- stan_fit
codafit_stan_draws_consumption_full_pooling <- as.matrix(stan2coda(stan_fit_consumption_full_pooling))
...
pdf("output/posterior_parent_quantile_TEs_temptation_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  ...
  theme(plot.title = element_text(size = 16)) + xlim(0.05,0.95) + ylim(-15,60) +
...
posterior_beta_data_plot <- ggplot(posterior_beta_data, aes(posterior_beta_data$quantiles_list))
pdf("output/posterior_parent_quantile_TEs_consumerdurables_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "red", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "red", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"50%"]), color = "dark red", size = 1.5) +
  ggtitle("Posterior quantile effects on consumerdurables") +
  theme(plot.title = element_text(size = 16)) + xlim(0.05,0.95) + ylim(-275,1100) +
  xlab("Quantiles") + ylab("Quantile treatment effect")+
  theme(axis.text = element_text(size=14)) +  theme(axis.title.y = element_text(size = 14)) +  theme(axis.title.x = element_text(size = 14))
dev.off()
...
posterior_beta_data_plot <- ggplot(posterior_beta_data, aes(posterior_beta_data$quantiles_list))
pdf("output/posterior_parent_quantile_TEs_consumption_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "red", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "red", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"mean"]), color = "dark red", size = 1.5) +
...
posterior_beta_data_plot <- ggplot(posterior_beta_data, aes(posterior_beta_data$quantiles_list))
pdf("output/posterior_predicted_quantile_TEs_temptation_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "red", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "red", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"50%"]), color = "dark red", size = 1.5) +
  ggtitle("Posterior predicted quantile effects on temptation") +
  theme(plot.title = element_text(size = 14)) + xlim(0.05,0.95) + ylim(-100,400) +
  xlab("Quantiles") +ylab("Quantile treatment effect")+
  theme(axis.text = element_text(size=14)) +  theme(axis.title.y = element_text(size = 14)) +  theme(axis.title.x = element_text(size = 14))
dev.off()
...
posterior_beta_data_plot <- ggplot(posterior_beta_data, aes(posterior_beta_data$quantiles_list))
pdf("output/posterior_predicted_quantile_TEs_consumerdurables_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "red", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "red", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"50%"]), color = "dark red", size = 1.5) +
  ggtitle("Posterior predicted quantile effects on consumerdurables") +
  theme(plot.title = element_text(size = 14)) + xlim(0.05,0.95) +  ylim(-60000,240000) +
  xlab("Quantiles") +ylab("Quantile treatment effect")+
  theme(axis.text = element_text(size=14)) +  theme(axis.title.y = element_text(size = 14)) +  theme(axis.title.x = element_text(size = 14))
dev.off()
...
posterior_beta_data_plot <- ggplot(posterior_beta_data, aes(posterior_beta_data$quantiles_list))
pdf("output/posterior_predicted_quantile_TEs_consumption_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "red", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "red", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"50%"]), color = "dark red", size = 1.5) +
  ggtitle("Posterior predicted quantile effects on consumption") +
  theme(plot.title = element_text(size = 14)) + xlim(0.05,0.95)  + ylim(-1500,6000) +
  xlab("Quantiles") + ylab("Quantile treatment effect")+
  theme(axis.text = element_text(size=14)) +  theme(axis.title.y = element_text(size = 14)) +  theme(axis.title.x = element_text(size = 14))
dev.off()
...
codafit_stan_draws <- codafit_stan_draws_consumerdurables_full_pooling
S <- dim(codafit_stan_draws)[1]
M <- 2 # mixture components
component_probs <- matrix(NA,nrow=S,ncol=M)
quantile_vec <- seq(0.05, 0.95,0.1)
...
# This used to be here and I dont know why I suspect redundant but saving in case
# quantile_value_output_difference <-  quantile_value_output_treatment -  quantile_value_output_control
# 
# 
# quantile_value_output_control_mean <- apply(quantile_value_output_control,2,mean)
...
posterior_beta_data_plot +
  ...
  theme(plot.title = element_text(size = 16)) + xlim(0.05,0.95) + ylim(-230,200) +
  xlab("Quantiles") + ylab("Quantile treatment effect")+
  theme(axis.text = element_text(size=14)) +  theme(axis.title.y = element_text(size = 14)) +  theme(axis.title.x = element_text(size = 14))
dev.off()
...
posterior_beta_data_plot <- ggplot(posterior_beta_data, aes(posterior_beta_data$quantiles_list))
pdf("output/posterior_parent_quantile_TEs_consumerdurables_full_pooling_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "dark green", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "dark green", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"50%"]), color = "dark green", size = 1.5) +
  ggtitle("Full Pooling posterior quantile effects on consumerdurables") +
  theme(plot.title = element_text(size = 16)) + xlim(0.05,0.95) + ylim(-120,475) +
  xlab("Quantiles") + ylab("Quantile treatment effect")+
  theme(axis.text = element_text(size=14)) +  theme(axis.title.y = element_text(size = 14)) +  theme(axis.title.x = element_text(size = 14))
dev.off()
pdf("output/posterior_parent_quantile_TEs_consumerdurables_full_pooling_compare_predictive_lognormal.pdf", width=6.5, height=6)
posterior_beta_data_plot +
  geom_ribbon(aes(ymin = posterior_beta_data[,"2.5%"], ymax = posterior_beta_data[,"97.5%"]), fill = "dark green", alpha=0.3) +
  geom_ribbon(aes(ymin = posterior_beta_data[,"25%"], ymax = posterior_beta_data[,"75%"]), fill = "dark green", alpha=0.6) +
  geom_line(aes(y = posterior_beta_data[,"50%"]), color = "dark green", size = 1.5) +
